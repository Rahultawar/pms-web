                        ...
                        <div class="container-fluid">
                            <div class="row align-items-center mb-3">
                                <div class="col-md-6 col-12 mb-2 mb-md-0">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0" id="breadcrumbItem">
                                            ...
                                            <li class="breadcrumb-item" id="productBreadcrumbLink"><a
                                                    href="ProductServlet">Product</a></li>
                                ...
                                <div class="col-md-3 col-12 text-end">
                                    <button class="btn btn-outline-success" id="addProduct" data-action="show-form"
                                        data-mode="add">
                                ...
                                <c:choose>
                                    <c:when test="${empty productList}">
                                        <div id="noProductAvailable" class="empty-state">
                                            ...
                                            <p class="empty-state__subtitle">Add your first product to start tracking
                                                inventory and
                                                    ...
                                                    <tbody>
                                                        <c:forEach var="product" items="${productList}">
                                                            <tr>
                                                                ...
                                                                <td><a href="ProductServlet?viewId=${product.productId}"
                                                                        title="View Details"><i
                                                                            class="fas fa-info-circle"></i></a></td>
                                                                <td><a href="ProductServlet?id=${product.productId}"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-floating mb-3">
                                                    <select class="form-control" id="category" name="selCategory">
                                                        ...
                                                        <option value="Analgesic" <c:if
                                                            test="${p != null and p.category == 'Analgesic'}">selected
                                                            </c:if>>
                                                            Analgesic
                                                        </option>
                                                        <option value="Antacid" <c:if
                                                            test="${p != null and p.category == 'Antacid'}">selected
                                                            </c:if>>
                                                            Antacid
                                                        </option>
                                                        <option value="Antiseptic" <c:if
                                                            test="${p != null and p.category == 'Antiseptic'}">selected
                                                            </c:if>>
                                                            Antiseptic
                                                        </option>
                                                        <option value="Antifungal" <c:if
                                                            test="${p != null and p.category == 'Antifungal'}">selected
                                                            </c:if>>
                                                            Antifungal
                                                        </option>
                                                        <option value="Antiviral" <c:if
                                                            test="${p != null and p.category == 'Antiviral'}">selected
                                                            </c:if>>
                                                            Antiviral
                                                        </option>
                                                        <option value="Anti-inflammatory" <c:if
                                                            test="${p != null and p.category == 'Anti-inflammatory'}">
                                                            selected</c:if>>
                                                            Anti-inflammatory
                                                        </option>
                                                        <option value="Antiallergic" <c:if
                                                            test="${p != null and p.category == 'Antiallergic'}">
                                                            selected</c:if>>
                                                            Antiallergic
                                                        </option>
                                                        <option value="Antipyretic" <c:if
                                                            test="${p != null and p.category == 'Antipyretic'}">selected
                                                            </c:if>>
                                                            Antipyretic
                                                        </option>
                                                        <option value="Cough & Cold" <c:if
                                                            test="${p != null and p.category == 'Cough & Cold'}">
                                                            selected</c:if>>
                                                            Cough & Cold
                                                        </option>
                                                        <option value="Vitamins & Supplements" <c:if
                                                            test="${p != null and p.category == 'Vitamins & Supplements'}">
                                                            selected</c:if>>
                                                            Vitamins & Supplements
                                                        </option>
                                                        <option value="Cardiac" <c:if
                                                            test="${p != null and p.category == 'Cardiac'}">selected
                                                            </c:if>>
                                                            Cardiac
                                                        </option>
                                                        <option value="Diabetic Care" <c:if
                                                            test="${p != null and p.category == 'Diabetic Care'}">
                                                            selected</c:if>>
                                                            Diabetic Care
                                                        </option>
                                                        <option value="Gastrointestinal" <c:if
                                                            test="${p != null and p.category == 'Gastrointestinal'}">
                                                            selected</c:if>>
                                                            Gastrointestinal
                                                        </option>
                                                        <option value="Dermatology" <c:if
                                                            test="${p != null and p.category == 'Dermatology'}">selected
                                                            </c:if>>
                                                            Dermatology
                                                        </option>
                                                        <option value="Neurology" <c:if
                                                            test="${p != null and p.category == 'Neurology'}">selected
                                                            </c:if>>
                                                            Neurology
                                                        </option>
                                                        <option value="Ophthalmic" <c:if
                                                            test="${p != null and p.category == 'Ophthalmic'}">selected
                                                            </c:if>>
                                                            Ophthalmic
                                                        </option>
                                                        <option value="ENT" <c:if
                                                            test="${p != null and p.category == 'ENT'}">selected</c:if>
                                                            >ENT
                                                        </option>
                                                        <option value="Pediatric" <c:if
                                                            test="${p != null and p.category == 'Pediatric'}">selected
                                                            </c:if>>
                                                            Pediatric
                                                        </option>
                                                        <option value="Gynecology" <c:if
                                                            test="${p != null and p.category == 'Gynecology'}">selected
                                                            </c:if>>
                                                            Gynecology
                                                        </option>
                                                        <option value="Personal Care" <c:if
                                                            test="${p != null and p.category == 'Personal Care'}">
                                                            selected</c:if>>
                                                            Personal Care
                                                        </option>
                                                        <option value="Cosmetics" <c:if
                                                            test="${p != null and p.category == 'Cosmetics'}">selected
                                                            </c:if>>
                                                            Cosmetics
                                                        </option>
                                                        <option value="Medical Devices" <c:if
                                                            test="${p != null and p.category == 'Medical Devices'}">
                                                            selected</c:if>>
                                                            Medical Devices
                                                        </option>
                                                        <option value="Surgical" <c:if
                                                            test="${p != null and p.category == 'Surgical'}">selected
                                                            </c:if>>
                                                            Surgical
                                                        </option>
                                                        <option value="Sanitizers & Disinfectants" <c:if
                                                            test="${p != null and p.category == 'Sanitizers & Disinfectants'}">
                                                            selected</c:if>>
                                                            Sanitizers & Disinfectants
                                                        </option>
                                                        <option value="Baby Care" <c:if
                                                            test="${p != null and p.category == 'Baby Care'}">selected
                                                            </c:if>>Baby
                                                            Care
                                                        </option>
                                                        <option value="OTC Products" <c:if
                                                            test="${p != null and p.category == 'OTC Products'}">
                                                            selected</c:if>>
                                                            OTC Products
                                                        </option>
                                                    </select>
                                                ...
                                                <div class="form-floating mb-3">
                                                    <input type="text" class="form-control" id="manufacturer"
                                                        name="txtManufacturer" placeholder="Manufacturer"
                                                ...
                                                <div class="form-floating mb-3">
                                                    <input type="text" class="form-control" id="batchNumber"
                                                        name="txtBatchNumber" placeholder="Batch Number"
                                                ...
                                                <div class="form-floating mb-3">
                                                    <input type="text" class="form-control" id="strength"
                                                        name="txtStrength" placeholder="Strength"
                                                ...
                                                <div class="form-floating mb-3">
                                                    <input type="text" class="form-control" id="location"
                                                        name="txtLocation" placeholder="Location"
                                                ...
                                                <div class="form-floating mb-3">
                                                    <select class="form-control" id="distributorId"
                                                        name="txtDistributorId" required>
                                                        <option value="">Select Distributor</option>
                                                        <c:forEach var="distributor"
                                                            items="${requestScope.distributorList}">
                                                            <option value="${distributor.distributorId}"
                                                                ${distributor.distributorId==requestScope.productDetails.distributorId
                                                                ? 'selected' : '' }>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3">
                                                    <input type="date" class="form-control" id="manufacturingDate"
                                                        name="manufacturingDate" placeholder="Manufacturing Date"
                                                        value="${requestScope.productDetails.manufacturingDate}"
                                                        required>
                                                ...
                                                <div class="form-floating mb-3">
                                                    <input type="date" class="form-control" id="expiryDate"
                                                        name="expiryDate" placeholder="Expiry Date"
                                                ...
                                                <div class="form-floating mb-3">
                                                    <input type="number" class="form-control" id="reorderLevel"
                                                        name="txtReorderLevel" placeholder="Reorder Level"
                                                ...
                                                <div class="form-floating mb-3">
                                                    <input type="number" step="0.01" class="form-control"
                                                        id="purchasingPrice" name="txtPurchasingPrice"
                                                ...
                                                <div class="form-floating mb-3">
                                                    <input type="number" step="0.01" class="form-control"
                                                        id="sellingPrice" name="txtSellingPrice"
                                                ...
                                                <div class="form-floating mb-3">
                                                    <select class="form-control" id="unit" name="selUnit" required>
                                                        ...
                                                        <option value="tube" ${requestScope.productDetails.unit=='tube'
                                                            ? 'selected' : '' }>
                                                            Tube
                                                        </option>
                                                        <option value="vial" ${requestScope.productDetails.unit=='vial'
                                                            ? 'selected' : '' }>
                                                            Vial
                                                        </option>
                                                        <option value="strip"
                                                            ${requestScope.productDetails.unit=='strip' ? 'selected'
                                                            : '' }>
                                                            Strip
                                                        </option>
                                                        <option value="bottle"
                                                            ${requestScope.productDetails.unit=='bottle' ? 'selected'
                                                            : '' }>
                                                            Bottle
                                                        </option>
                                                        <option value="sachet"
                                                            ${requestScope.productDetails.unit=='sachet' ? 'selected'
                                                            : '' }>
                                                            Sachet
                                                        </option>
                                                        <option value="box" ${requestScope.productDetails.unit=='box'
                                                            ? 'selected' : '' }>
                                                            Box
                                                        </option>
                                                        <option value="piece"
                                                            ${requestScope.productDetails.unit=='piece' ? 'selected'
                                                            : '' }>
                                                            Piece
                                                        </option>
                                                        <option value="ampoule"
                                                            ${requestScope.productDetails.unit=='ampoule' ? 'selected'
                                                            : '' }>
                                                            Ampoule
                                                        </option>
                                                        <option value="syringe"
                                                            ${requestScope.productDetails.unit=='syringe' ? 'selected'
                                                            : '' }>
                                                            Syringe
                                                        </option>
                                                        <option value="injection"
                                                            ${requestScope.productDetails.unit=='injection' ? 'selected'
                                                            : '' }>
                                                            Injection
                                                        </option>
                                                        <option value="pack" ${requestScope.productDetails.unit=='pack'
                                                            ? 'selected' : '' }>
                                                            Pack
                                                        </option>
                                                        <option value="roll" ${requestScope.productDetails.unit=='roll'
                                                            ? 'selected' : '' }>
                                                            Roll
                                                        </option>
                                                    </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <p><strong>Distributor:</strong>
                                                <c:forEach var="dist" items="${distributorList}">
                                                    <c:if test="${dist.distributorId == productDetails.distributorId}">
                                                        ${dist.distributorName}</c:if>
                                                </c:forEach>
                                            </p>
                                            <p><strong>Sub Quantity:</strong> ${productDetails.subQuantity > 0 ?
                                                productDetails.subQuantity : 'N/A'}</p>
                                        </div>
                                        <div class="col-md-6">
                                            <p><strong>Manufacturing Date:</strong> ${productDetails.manufacturingDate}
                                            </p>
